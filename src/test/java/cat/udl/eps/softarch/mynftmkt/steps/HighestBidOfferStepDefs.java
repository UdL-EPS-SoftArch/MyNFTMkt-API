...
public class HighestBidOfferStepDefs {
    ...
    @When("^I make Highest Bid NFT Offer I set a minimum price \"([^\"]*)\" and price to reserve \"([^\"]*)\" and select the expiration date \"([^\"]*)\" .$")
    ...
    @When("^I remove a Higher Bid NFT Bid with id \"([^\"]*)\" .$")
    ...
    @When("^I modify Highest Bid NFT Offer with id \"([^\"]*)\" I set a minimum price \"([^\"]*)\" and price to reserve \"([^\"]*)\" and select the expiration date \"([^\"]*)\" .$")
    ...
    @When("Select the NTF {string} for option Highest Bid NFT Offer .")
    public void select_the_ntf(String string) {
        ntf = ntfRepository.findByTitle(string);
    }

    @When("The Highest Bid NFT Offer is associated with the NTF {string} .")
